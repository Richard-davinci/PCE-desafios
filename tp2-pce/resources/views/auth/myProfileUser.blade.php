          ...
          <div class="card  shadow-sm">
            <div class="card-body">
              <div
                ...
                <a class="btn btn-turquesa mt-3 mt-md-0" href="{{route('pages.viewService',5)}}">Ver
                  servicio</a>
              </div>
            </div>
          </div>
      ...
      <div class="modal-content border-light">
        ...
        <div class="modal-body">
          ...
          <div class="vstack gap-2">
            <div class="form-check"><input class="form-check-input" type="radio" name="planOpt"
                                           id="optStarter"
            ...
            <div class="form-check"><input class="form-check-input" type="radio" name="planOpt" id="optPro"
                                           value="Pro"><label class="form-check-label"
                                                              for="optPro">Pro</label></div>
            <div class="form-check"><input class="form-check-input" type="radio" name="planOpt"
                                           id="optPremium"
